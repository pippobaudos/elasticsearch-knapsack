 ...
 */
package org.xbib.elasticsearch.rest.action.knapsack.suggest;
 ...
 */
public class RestBuildSuggestAction extends BaseRestHandler implements KnapsackParameter {

    private final static ESLogger logger = ESLoggerFactory.getLogger(RestBuildSuggestAction.class.getSimpleName());

    @Inject
    public RestBuildSuggestAction(Settings settings, Client client, RestController controller) {
