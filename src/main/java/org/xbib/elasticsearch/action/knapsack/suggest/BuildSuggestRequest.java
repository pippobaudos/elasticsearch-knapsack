...
public class BuildSuggestRequest extends ActionRequest<BuildSuggestRequest>
    ...
    public BuildSuggestRequest setArchivePath(Path archivePath) {
    ...
    public BuildSuggestRequest setIndex(String index) {
        this.index = index;
        return this;
    }
    ...
    public BuildSuggestRequest setType(String type) {
        this.type = type;
        return this;
    }
    ...
    public BuildSuggestRequest setLimit(int limit) {
        this.limit = limit;
        return this;
    }
    ...
    public BuildSuggestRequest setIndexTypeNames(Map<String, Object> indexTypeNames) {
    ...
    public BuildSuggestRequest setSearchRequest(SearchRequest searchRequest) {
    ...
    public BuildSuggestRequest setBytesToTransfer(ByteSizeValue bytesToTransfer) {
    ...
    public BuildSuggestRequest withMetadata(boolean withMetadata) {
    ...
    public BuildSuggestRequest setOverwriteAllowed(boolean overwrite) {
    ...
    public BuildSuggestRequest withAliases(boolean withAliases) {
