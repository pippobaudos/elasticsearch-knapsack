...
public class BuildSuggestResponse extends ActionResponse implements ToXContent {
    ...
    public BuildSuggestResponse setState(KnapsackState state) {
        this.state = state;
        return this;
    }
    ...
    public BuildSuggestResponse setRunning(boolean running) {
    ...
    public BuildSuggestResponse setReason(String reason) {
        this.reason = reason;
        return this;
    }
